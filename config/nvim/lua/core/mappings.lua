...
map("n", "<leader>ss",  "<cmd>Telescope codesearch find_files<cr>",  { desc = "Telescope Codesearch" })
map("n", "<leader>sd",  "<cmd>Telescope codesearch find_query<cr>",  { desc = "Telescope Codesearch" })
